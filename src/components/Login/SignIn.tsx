...
const SignIn = ({
  ...
  const handleSignIn = () => {
    ...
    onSignIn(formData.emailOrUsername, formData.password);
  };
        ...
        <Input>
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute cursor-pointer right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-gray-700 transition-colors duration-200"
            >
              {showPassword ? (
